...
img1 = cv2.imread("../Images/Pocket22-Trans.jpg") #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
def return_points(image_path, aruco_dict, parameters, pixel_cm_ratio):
    # Load the image
...
# GETTING 4 POINTS
processed_img, points, dimensions = return_points('../Images/P22.jpg', aruco_dict, parameters, pixel_cm_ratio) #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
